...
N = 5#0000 			# Number of iteration train 
M = 2#0000 			# after every 10k sentence, check validation and testing datas
n_f = 100 			# dim of word embedding
n_hidden = 100 			# number of nodes in hidden layer
model = 'ff' 			# model used for classification : 'ff' or 'rnn'
viterbi = True 			# structure output or not
trainer = 'AdagradTrainer' 	# Training method
lr = 0.05 			# learning rate
batch_size = 1 			# batch_size 
activation = T.tanh		# activation function
output_fname_dev = "results/nn_dev_res_100d_cbow_wu_"		# output file for dev result
output_fname_test = "results/nn_test_res_100d_cbow_wu_"		# output file for test result
